package program.Assessment;
import java.io.*;
import java.util.Scanner;
import java.io.IOException;
public class VirtualKeyRepos {
...
String st;
File mFolder =new File("C:\\Users\\SUREKHA J\\Desktop\\certificates\\JAVAMAIN");
mFolder.mkdir();
String location = "C:\\Users\\SUREKHA J\\Desktop\\certificates\\JAVAMAIN";
...
System.out.println("Press Enter to continue...");
 ...
 switch(choice) {
 case 1:
 File Fobj = new File("C:\\Users\\SUREKHA J\\Desktop\\certificates\\JAVAMAIN");
File Farray[] = Fobj.listFiles();
 ...
 st = sc.next();
 File fsearch = new File("C:\\Users\\SUREKHA J\\Desktop\\certificates\\JAVAMAIN");
